...
/**
 * Executado antes de processar a requisição
 * Obtém o Refresh Token do cookie para enviar na requisição caso necessário
 */
@Component
...
public class RefreshTokenCookiePreProcessor implements Filter {
	...
	public void doFilter(ServletRequest request, 
		...
		String path = req.getContextPath().concat("/oauth/token");
